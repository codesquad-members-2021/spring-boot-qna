...
#### 질문 데이터 저장하기
- [X] Question 클래스를 DB 테이블과 매핑
    - @Id, @GeneratedValue - key 생성
    - @Column - 필드와 테이블 칼럼 핑
- [X] QuestionRepostory 구현
   - extends CrudRepository
- [X] QuestionController와 QuestionRepoistory 의존관계 설정
   - @Autowired 추가
- [X] Question 데이터, DB에 저장
...
### 리펙토링
 ...
 - [X] @Autowired 대신 생성자로 Repository 의존성 주입
 - [X] Entity 객체 setter 제거, 생성자 정의
 - [ ] Repository객체.findById().get() 지양
     - [Optional 제대로 활용하기](https://www.latera.kr/blog/2019-07-02-effective-optional/)

  - [ ] ModelAndView로 통일
    - [When to use ModelAndView vs Model in Spring?](https://stackoverflow.com/questions/16951609/when-to-use-modelandview-vs-model-in-spring)
### 에러
