...
public class Question {
    ...
    private Question(User writer, String title, String contents, LocalDateTime createDateTime) {
        this.writer = writer;
        this.title = title;
