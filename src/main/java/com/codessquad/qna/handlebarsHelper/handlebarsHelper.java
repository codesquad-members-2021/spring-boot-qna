...
public class handlebarsHelper {
    ...
    private final Logger logger = LoggerFactory.getLogger(handlebarsHelper.class);
    ...
    public CharSequence questionPagination(Page<Question> questions, int pageNumber, Options options) {
