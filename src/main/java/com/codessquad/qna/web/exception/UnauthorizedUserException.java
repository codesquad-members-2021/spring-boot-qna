...
public class UnauthorizedUserException extends QnaException {
    ...
    public static final String UNAUTHORIZED_USER_TO_USER_INFO_UPDATE = "본인의 회원정보만 수정할 수 있습니다.";
    public static final String UNAUTHORIZED_USER_TO_ANSWER = "댓글 작성자가 아닙니다.";
