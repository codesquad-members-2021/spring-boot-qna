...
public class PageUtils {
    ...
    public static List<Integer> pageNumbers(int pageNum, int totalPageNum, int pageListSize) {
    ...
    public static int prevPageNumber(List<Integer> pageNumbers) {
    ...
    public static int nextPageNumber(List<Integer> pageNumbers, int totalPageNum) {
        if (pageNumbers != null && !pageNumbers.isEmpty()) {
