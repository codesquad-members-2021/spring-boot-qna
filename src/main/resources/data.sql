...
--INSERT INTO ANSWER (ID, CONTENTS, CREATED_DATE_TIME, QUESTION_ID, WRITER_ID)
--VALUES (null ,'양념치킨을 고려해보면 어떨까 달콤하고',{ts '2021-03-24 12:34:56'},2,5)

--INSERT INTO ANSWER (ID, CONTENTS, CREATED_DATE_TIME, QUESTION_ID, WRITER_ID)
--VALUES (null ,'그돈이면 차라리 따끈하고 뜨끈한 국밥이 네그릇인데',{ts '2021-03-24 12:34:56'},2,5)
